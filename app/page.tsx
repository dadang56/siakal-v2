...
export default function LandingPage() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col justify-between overflow-x-hidden text-white bg-slate-950 font-sans transition-colors duration-200">
      ...
      {/* Landing Page Hero & Pure Liquid Glass Login Card Box */}
      <main className="relative z-10 max-w-[1920px] w-full mx-auto px-4 sm:px-8 lg:px-12 py-10 flex-1 flex items-center">
        <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            <div className="pt-2">
              <Link
                ...
                className="inline-flex items-center gap-2 py-3 px-5 rounded-2xl bg-white/20 hover:bg-white/35 backdrop-blur-xl border border-white/30 text-xs sm:text-sm font-extrabold text-white transition-all shadow-xl"
              >
          ...
          {/* Right Column: Premium Liquid Glass Embedded Login Card Box */}
          <div className="lg:col-span-5 w-full max-w-md mx-auto">
            <div className="bg-slate-950/30 dark:bg-slate-950/40 backdrop-blur-2xl p-6 sm:p-8 border border-white/30 dark:border-white/20 shadow-[0_20px_50px_rgba(0,0,0,0.3)] rounded-3xl relative overflow-hidden space-y-5 text-white">
              
              <div className="text-center">
                <div className="w-12 h-12 mx-auto mb-2 rounded-2xl bg-gradient-to-tr from-sky-400 to-blue-500 p-0.5 shadow-glow flex items-center justify-center font-black text-white text-xl">
                  S
                </div>
                <h2 className="text-xl sm:text-2xl font-black tracking-wide text-white drop-shadow-md">Masuk ke SIAKAL</h2>
                <p className="text-xs font-semibold text-slate-200 drop-shadow-sm mt-0.5">Politeknik Transportasi SDP Palembang</p>
              </div>

              {/* Login Form */}
              <form onSubmit={handleLogin} className="space-y-3.5">
                {errorMsg && (
                  <div className="p-3 rounded-xl bg-red-500/20 backdrop-blur-md border border-red-400/40 text-white text-xs font-bold shadow-md">
                    {errorMsg}
                  </div>
                )}
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-white/15 dark:bg-slate-900/50 backdrop-blur-md border border-white/30 text-white placeholder-slate-200 text-xs sm:text-sm font-medium focus:outline-none focus:border-sky-400 focus:bg-white/25 transition-all shadow-inner"
                  />
                </div>
                ...
                <button
                  type="submit"
                  className="w-full py-3.5 px-4 rounded-xl bg-gradient-to-r from-sky-500 via-blue-600 to-indigo-600 hover:from-sky-400 hover:to-indigo-500 text-white font-extrabold text-xs sm:text-sm flex items-center justify-center gap-2 shadow-xl shadow-sky-500/30 transition-all active:scale-[0.98] cursor-pointer mt-1"
                >
              ...
              <div className="pt-4 border-t border-white/20 space-y-2.5">
                <div className="flex items-center justify-center gap-1.5 text-[11px] font-extrabold text-sky-200 uppercase tracking-wider drop-shadow-sm">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 text-xs font-extrabold">
                  <button
                    ...
                    className="py-2 px-2 rounded-xl bg-white/20 hover:bg-white/35 backdrop-blur-md text-white border border-white/30 transition-all flex items-center justify-center gap-1 cursor-pointer active:scale-95 shadow-sm"
